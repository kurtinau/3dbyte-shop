...
import { checkVariantColor, hasColorVariant } from "utils/productVariantHandler";
...
export const ProductGrid = ({
  ...
  if (
    !data ||
    !data.productsWithHasMore ||
    data.productsWithHasMore.items.length === 0
  ) {
    ...
    <section>
      <Grid style={style}>
        {items.map((product, idx) => {
          ...
          const productWithImage = formatProductImageUrl(product);
          return (
            <ProductCard
